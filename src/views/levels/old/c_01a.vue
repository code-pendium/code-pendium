...
description = 
`<p>
In the previous problem, you've created a simple 4-operation calculator. 
Now it's time to one it up and make a slightly more advanced version. 
In this problem, you will be making a step calculator. 
Each input will consist of multiple "steps" that the calculator should execute. 
